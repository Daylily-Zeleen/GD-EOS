...
Signal IEOS::playerdatastorage_interface_query_file(Ref<RefCounted> p_options) {
    ...
    EOS_PlayerDataStorage_QueryFile(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_QueryFileCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_query_file_callback", ref_ret);
    });

    return SIGNAL("playerdatastorage_interface_query_file_callback");
}

Signal IEOS::playerdatastorage_interface_query_file_list(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_PlayerDataStorage_QueryFileList(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_QueryFileListCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_query_file_list_callback", ref_ret);
    });

    return SIGNAL("playerdatastorage_interface_query_file_list_callback");
}
...
Signal IEOS::playerdatastorage_interface_duplicate_file(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_PlayerDataStorage_DuplicateFile(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_DuplicateFileCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_duplicate_file_callback", ref_ret);
    });

    return SIGNAL("playerdatastorage_interface_duplicate_file_callback");
}

Signal IEOS::playerdatastorage_interface_delete_file(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString filename = VARIANT_TO_CHARSTRING(p_options->get("filename"));
    ...
    EOS_PlayerDataStorage_DeleteFile(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_DeleteFileCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_delete_file_callback", ref_ret);
    });

    return SIGNAL("playerdatastorage_interface_delete_file_callback");
}

EOS_EResult IEOS::playerdatastorage_interface_delete_cache(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_EResult res = EOS_PlayerDataStorage_DeleteCache(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_DeleteCacheCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_delete_cache_callback", ref_ret);
    });

    return static_cast<EOS_EResult>(res);
}

Ref<EOSGPlayerDataStorageFileTransferRequest> IEOS::playerdatastorage_interface_read_file(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString filename = VARIANT_TO_CHARSTRING(p_options->get("filename"));
    int read_chunk_length_bytes = p_options->get("read_chunk_length_bytes");

    Ref<EOSGPlayerDataStorageFileTransferRequest> wrapper;
    wrapper.instantiate();
    ...
    options.ReadFileDataCallback = [](const EOS_PlayerDataStorage_ReadFileDataCallbackInfo *data) {
        ...
        Ref<EOSGPlayerDataStorageFileTransferRequest> wrapper = client_data->get_meta(get_rw_meta_name());
        wrapper->read_file_data_callback(ret.to_dict());

        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_read_file_data_callback", ref_ret);
    ...
    options.FileTransferProgressCallback = [](const EOS_PlayerDataStorage_FileTransferProgressCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_file_transfer_progress_callback", ref_ret);
    };
    p_options->reference();
    ...
    EOS_HPlayerDataStorageFileTransferRequest fileTranferRequest = EOS_PlayerDataStorage_ReadFile(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_ReadFileCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_read_file_callback", ref_ret);
    });
...
Ref<EOSGPlayerDataStorageFileTransferRequest> IEOS::playerdatastorage_interface_write_file(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString filename = VARIANT_TO_CHARSTRING(p_options->get("filename"));
    ...
    options.WriteFileDataCallback = [](const EOS_PlayerDataStorage_WriteFileDataCallbackInfo *data, void *outDataBuffer, uint32_t *bytesWritten) {
        ...
        Ref<EOSGPlayerDataStorageFileTransferRequest> wrapper = client_data->get_meta(get_rw_meta_name());
        wrapper->write_file_data_callback(ret.to_dict());

        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_write_file_data_callback", ref_ret);
    ...
    EOS_HPlayerDataStorageFileTransferRequest fileTranferRequest = EOS_PlayerDataStorage_WriteFile(s_playerDataStorageInterface, &options, (void *)*p_options, [](const EOS_PlayerDataStorage_WriteFileCallbackInfo *data) {
        ...
        Ref<EOSGPlayerDataStorageFileTransferRequest> wrapper = client_data->get_meta(get_rw_meta_name());
        wrapper->write_file_callback(ret.to_dict());

        IEOS::get_singleton()->emit_signal("playerdatastorage_interface_write_file_callback", ref_ret);
    });
    wrapper->wrap(fileTranferRequest);
    return wrapper;
    // return eosg_playerdatastorage_file_tranfer_request_to_wrapper(fileTranferRequest);
