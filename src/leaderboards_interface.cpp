...
Signal IEOS::leaderboards_interface_query_leaderboard_definitions(Ref<RefCounted> p_options) {
    ...
    EOS_Leaderboards_QueryLeaderboardDefinitions(s_leaderboardsInterface, &options, (void *)*p_options, [](const EOS_Leaderboards_OnQueryLeaderboardDefinitionsCompleteCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("leaderboards_interface_query_leaderboard_definitions_callback", ref_ret);
    });

    return SIGNAL("leaderboards_interface_query_leaderboard_definitions_callback");
}

Signal IEOS::leaderboards_interface_query_leaderboard_ranks(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString leaderboard_id = VARIANT_TO_CHARSTRING(p_options->get("leaderboard_id"));
    ...
    EOS_Leaderboards_QueryLeaderboardRanks(s_leaderboardsInterface, &options, (void *)*p_options, [](const EOS_Leaderboards_OnQueryLeaderboardRanksCompleteCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["client_data"] = client_data->get("client_data");
        IEOS::get_singleton()->emit_signal("leaderboards_interface_query_leaderboard_ranks_callback", ref_ret);
    });

    return SIGNAL("leaderboards_interface_query_leaderboard_ranks_callback");
}

Signal IEOS::leaderboards_interface_query_leaderboard_user_scores(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Leaderboards_QueryLeaderboardUserScores(s_leaderboardsInterface, &options, (void *)*p_options, [](const EOS_Leaderboards_OnQueryLeaderboardUserScoresCompleteCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["client_data"] = client_data->get("client_data");
        IEOS::get_singleton()->emit_signal("leaderboards_interface_query_leaderboard_user_scores_callback", ref_ret);
    });

    return SIGNAL("leaderboards_interface_query_leaderboard_user_scores_callback");
}
