...
Signal IEOS::lobby_interface_create_lobby(Ref<RefCounted> p_options) {
    ...
    EOS_Lobby_CreateLobby(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_CreateLobbyCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("lobby_interface_create_lobby_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_create_lobby_callback");
}

Signal IEOS::lobby_interface_destroy_lobby(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString lobby_id = VARIANT_TO_CHARSTRING(p_options->get("lobby_id"));
    ...
    EOS_Lobby_DestroyLobby(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_DestroyLobbyCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_destroy_lobby_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_destroy_lobby_callback");
}

Signal IEOS::lobby_interface_join_lobby(Ref<RefCounted> p_options) {
    Ref<EOSGLobbyDetails> p_lobby_details = Object::cast_to<EOSGLobbyDetails>(p_options->get("lobby_details"));
    ERR_FAIL_NULL_V_MSG(p_lobby_details, Signal(singleton, "lobby_interface_join_lobby_callback"), "Error joining lobby. JoinLobbyOptions.lobby_details is null.");
    ERR_FAIL_NULL_V_MSG(p_lobby_details->get_internal(), Signal(singleton, "lobby_interface_join_lobby_callback"), "Error joining lobby. EOSGLobbyDetails is null.");
    ...
    EOS_Lobby_JoinLobby(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_JoinLobbyCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_join_lobby_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_join_lobby_callback");
}

Signal IEOS::lobby_interface_join_lobby_by_id(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString lobby_id = VARIANT_TO_CHARSTRING(p_options->get("lobby_id"));
    ...
    EOS_Lobby_JoinLobbyById(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_JoinLobbyByIdCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_join_lobby_by_id_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_join_lobby_by_id_callback");
}

Signal IEOS::lobby_interface_leave_lobby(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString lobby_id = VARIANT_TO_CHARSTRING(p_options->get("lobby_id"));
    ...
    EOS_Lobby_LeaveLobby(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_LeaveLobbyCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_leave_lobby_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_leave_lobby_callback");
}
...
Signal IEOS::lobby_interface_update_lobby(Ref<RefCounted> p_options) {
    Ref<EOSGLobbyModification> lobby_modification = Object::cast_to<EOSGLobbyModification>(p_options->get("lobby_modification"));
    ERR_FAIL_NULL_V_MSG(lobby_modification, Signal(singleton, "lobby_interface_update_lobby_callback"), "Error updating lobby. UpdateLobbyOptions.lobby_modification is null.");
    ERR_FAIL_NULL_V_MSG(lobby_modification->get_internal(), Signal(singleton, "lobby_interface_update_lobby_callback"), "Error updating lobby. EOSGLobbyModification is null.");
    ...
    EOS_Lobby_UpdateLobby(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_UpdateLobbyCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_update_lobby_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_update_lobby_callback");
}

Signal IEOS::lobby_interface_promote_member(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Lobby_PromoteMember(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_PromoteMemberCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_promote_member_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_promote_member_callback");
}

Signal IEOS::lobby_interface_kick_member(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString target_user_id = VARIANT_TO_CHARSTRING(p_options->get("target_user_id"));
    CharString lobby_id = VARIANT_TO_CHARSTRING(p_options->get("lobby_id"));
    ...
    EOS_Lobby_KickMember(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_KickMemberCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_kick_member_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_kick_member_callback");
}

Signal IEOS::lobby_interface_hard_mute_member(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString target_user_id = VARIANT_TO_CHARSTRING(p_options->get("target_user_id"));
    CharString lobby_id = VARIANT_TO_CHARSTRING(p_options->get("lobby_id"));
    ...
    EOS_Lobby_HardMuteMember(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_HardMuteMemberCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("lobby_interface_hard_mute_member_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_hard_mute_member_callback");
}

Signal IEOS::lobby_interface_send_invite(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString target_user_id = VARIANT_TO_CHARSTRING(p_options->get("target_user_id"));
    CharString lobby_id = VARIANT_TO_CHARSTRING(p_options->get("lobby_id"));
    ...
    EOS_Lobby_SendInvite(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_SendInviteCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["lobby_id"] = EOSG_GET_STRING(data->LobbyId);
        IEOS::get_singleton()->emit_signal("lobby_interface_send_invite_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_send_invite_callback");
}

Signal IEOS::lobby_interface_reject_invite(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Lobby_RejectInvite(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_RejectInviteCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("lobby_interface_reject_invite_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_reject_invite_callback");
}

Signal IEOS::lobby_interface_query_invites(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Lobby_QueryInvites(s_lobbyInterface, &options, (void *)*p_options, [](const EOS_Lobby_QueryInvitesCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("lobby_interface_query_invites_callback", ref_ret);
    });

    return SIGNAL("lobby_interface_query_invites_callback");
}
