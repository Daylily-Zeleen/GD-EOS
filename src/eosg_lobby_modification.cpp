...
EOS_EResult EOSGLobbyModification::set_bucket_id(const String &p_bucket_id) {
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_SetBucketId(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::set_permission_level(int p_permission_level) {
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_SetPermissionLevel(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::set_max_members(int p_max_members) {
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_SetMaxMembers(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::set_invites_allowed(bool p_invites_allowed) {
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_SetInvitesAllowed(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::add_attribute(const String &p_key, Variant p_value, int p_visibility) {
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_AddAttribute(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::remove_attribute(const String &p_key) {
    CharString key = p_key.utf8();
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_RemoveAttribute(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::add_member_attribute(const String &p_key, Variant p_value, int p_visibility) {
    CharString key = p_key.utf8();
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_AddMemberAttribute(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::remove_member_attribute(const String &p_key) {
    CharString key = p_key.utf8();
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_RemoveMemberAttribute(m_internal, &options));
}

EOS_EResult EOSGLobbyModification::set_allowed_platform_ids(const TypedArray<int> &p_platform_ids) {
    ...
    return static_cast<EOS_EResult>(EOS_LobbyModification_SetAllowedPlatformIds(m_internal, &options));
}