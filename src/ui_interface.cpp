...
EOS_EResult IEOS::ui_interface_acknowledge_event_id(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_UI_AcknowledgeEventId(s_uiInterface, &options));
}
...
EOS_UI_ENotificationLocation IEOS::ui_interface_get_notification_location_preference() {
    return static_cast<EOS_UI_ENotificationLocation>(EOS_UI_GetNotificationLocationPreference(s_uiInterface));
}

EOS_UI_EKeyCombination IEOS::ui_interface_get_toggle_friends_key(Ref<RefCounted> p_options) {
    EOS_UI_GetToggleFriendsKeyOptions options;
    memset(&options, 0, sizeof(options));
    options.ApiVersion = EOS_UI_GETTOGGLEFRIENDSKEY_API_LATEST;

    return static_cast<EOS_UI_EKeyCombination>(EOS_UI_GetToggleFriendsKey(s_uiInterface, &options));
}

Signal IEOS::ui_interface_hide_friends(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_UI_HideFriends(s_uiInterface, &options, (void *)*p_options, [](const EOS_UI_HideFriendsCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ui_interface_hide_friends_callback", ref_ret);
    });

    return SIGNAL("ui_interface_hide_friends_callback");
}

bool IEOS::ui_interface_is_valid_key_combination(EOS_UI_EKeyCombination key_combination) {
    return EOSG_GET_BOOL(EOS_UI_IsValidKeyCombination(s_uiInterface, static_cast<EOS_UI_EKeyCombination>(key_combination)));
}

EOS_EResult IEOS::ui_interface_set_display_preference(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_UI_SetDisplayPreference(s_uiInterface, &options));
}

EOS_EResult IEOS::ui_interface_set_toggle_friends_key(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_UI_SetToggleFriendsKey(s_uiInterface, &options));
}

Signal IEOS::ui_interface_show_friends(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_UI_ShowFriends(s_uiInterface, &options, (void *)*p_options, [](const EOS_UI_ShowFriendsCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_epic_account_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("ui_interface_show_friends_callback", ref_ret);
    });

    return SIGNAL("ui_interface_show_friends_callback");
}
...
Signal IEOS::ui_interface_show_block_player(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_UI_ShowBlockPlayer(s_uiInterface, &options, (void *)*p_options, [](const EOS_UI_OnShowBlockPlayerCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ui_interface_show_block_player_callback", ref_ret);
    });

    return SIGNAL("ui_interface_show_block_player_callback");
}

Signal IEOS::ui_interface_show_report_player(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString target_user_id = VARIANT_TO_CHARSTRING(p_options->get("target_user_id"));
    ...
    EOS_UI_ShowReportPlayer(s_uiInterface, &options, (void *)*p_options, [](const EOS_UI_OnShowReportPlayerCallbackInfo *data) {
        ...
        ret["local_user_id"] = eosg_epic_account_id_to_string(data->LocalUserId);
        ret["target_user_id"] = eosg_epic_account_id_to_string(data->TargetUserId);
        IEOS::get_singleton()->emit_signal("ui_interface_show_report_player_callback", ref_ret);
    });

    return SIGNAL("ui_interface_show_report_player_callback");
}

EOS_EResult IEOS::ui_interface_pause_social_overlay(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_UI_PauseSocialOverlay(s_uiInterface, &options));
}
...
EOS_EResult IEOS::ui_interface_set_toggle_friends_button(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_UI_SetToggleFriendsButton(s_uiInterface, &options));
}

EOS_EResult IEOS::ui_interface_get_toggle_friends_button(Ref<RefCounted> p_options) {
    EOS_UI_GetToggleFriendsButtonOptions options;
    memset(&options, 0, sizeof(options));
    options.ApiVersion = EOS_UI_GETTOGGLEFRIENDSBUTTON_API_LATEST;

    return static_cast<EOS_EResult>(EOS_UI_GetToggleFriendsButton(s_uiInterface, &options));
}

bool IEOS::ui_interface_is_valid_button_combination(EOS_UI_EInputStateButtonFlags p_button_combination) {
...
EOS_EResult IEOS::ui_interface_report_input_state(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_UI_ReportInputState(s_uiInterface, &options));
}

EOS_EResult IEOS::ui_interface_pre_present(Ref<RefCounted> p_options) {
    EOS_UI_PrePresentOptions options;
    memset(&options, 0, sizeof(options));
    options.ApiVersion = EOS_UI_PREPRESENT_API_LATEST;

    return static_cast<EOS_EResult>(EOS_UI_PrePresent(s_uiInterface, &options));
}

Signal IEOS::ui_interface_show_native_profile(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString target_user_id = VARIANT_TO_CHARSTRING(p_options->get("target_user_id"));
    ...
    EOS_UI_ShowNativeProfile(s_uiInterface, &options, (void *)*p_options, [](const EOS_UI_ShowNativeProfileCallbackInfo *data) {
        ...
        ret["local_user_id"] = eosg_epic_account_id_to_string(data->LocalUserId);
        ret["target_user_id"] = eosg_epic_account_id_to_string(data->TargetUserId);
        IEOS::get_singleton()->emit_signal("ui_interface_show_native_profile_callback", ref_ret);
    });

    return SIGNAL("ui_interface_show_native_profile_callback");
}