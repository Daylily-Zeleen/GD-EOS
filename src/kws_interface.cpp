...
Signal IEOS::kws_interface_create_user(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_KWS_CreateUser(s_kwsInterface, &options, (void *)*p_options, [](const EOS_KWS_CreateUserCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("kws_interface_create_user_callback", ref_ret);
    });

    return SIGNAL("kws_interface_create_user_callback");
}
...
Signal IEOS::kws_interface_query_age_gate(Ref<RefCounted> p_options) {
    ...
    EOS_KWS_QueryAgeGate(s_kwsInterface, &options, (void *)*p_options, [](const EOS_KWS_QueryAgeGateCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("kws_interface_query_age_gate_callback", ref_ret);
    });

    return SIGNAL("kws_interface_query_age_gate_callback");
}

Signal IEOS::kws_interface_query_permissions(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_KWS_QueryPermissions(s_kwsInterface, &options, (void *)*p_options, [](const EOS_KWS_QueryPermissionsCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("kws_interface_query_permissions_callback", ref_ret);
    });

    return SIGNAL("kws_interface_query_permissions_callback");
}

Signal IEOS::kws_interface_request_permissions(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_KWS_RequestPermissions(s_kwsInterface, &options, (void *)*p_options, [](const EOS_KWS_RequestPermissionsCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("kws_interface_request_permissions_callback", ref_ret);
    });

    return SIGNAL("kws_interface_request_permissions_callback");
}

Signal IEOS::kws_interface_update_parent_email(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString parent_email = VARIANT_TO_CHARSTRING(p_options->get("parent_email"));
    ...
    EOS_KWS_UpdateParentEmail(s_kwsInterface, &options, (void *)*p_options, [](const EOS_KWS_UpdateParentEmailCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("kws_interface_update_parent_email_callback", ref_ret);
    });

    return SIGNAL("kws_interface_update_parent_email_callback");
}
