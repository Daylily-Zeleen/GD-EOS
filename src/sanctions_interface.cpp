...
Signal IEOS::sanctions_interface_query_active_player_sanctions(Ref<RefCounted> p_options) {
    ...
    EOS_Sanctions_QueryActivePlayerSanctions(s_sanctionsInterface, &options, (void *)*p_options, [](const EOS_Sanctions_QueryActivePlayerSanctionsCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("sanctions_interface_query_active_player_sanctions_callback", ref_ret);
    });

    return SIGNAL("sanctions_interface_query_active_player_sanctions_callback");
}
