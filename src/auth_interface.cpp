...
Signal IEOS::auth_interface_login(Ref<RefCounted> p_options) {
    ...
    EOS_Auth_Login(s_authInterface, &loginOptions, (void *)*p_options, [](const EOS_Auth_LoginCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("auth_interface_login_callback", ref_ret);
    });
    return SIGNAL("auth_interface_login_callback");
}

Signal IEOS::auth_interface_logout(Ref<RefCounted> p_options) {
    ...
    EOS_Auth_Logout(s_authInterface, &logoutOptions, (void *)*p_options, [](const EOS_Auth_LogoutCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_epic_account_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("auth_interface_logout_callback", ref_ret);
    });
    return SIGNAL("auth_interface_logout_callback");
}
...
Signal IEOS::auth_interface_delete_persistent_auth(Ref<RefCounted> p_options) {
    ...
    EOS_Auth_DeletePersistentAuth(s_authInterface, &options, (void *)*p_options, [](const EOS_Auth_DeletePersistentAuthCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["client_data"] = client_data->get("client_data");
        IEOS::get_singleton()->emit_signal("auth_interface_delete_persistent_auth_callback", ref_ret);
    });

    return SIGNAL("auth_interface_delete_persistent_auth_callback");
}
...
Signal IEOS::auth_interface_query_id_token(Ref<RefCounted> p_options) {
    ...
    EOS_Auth_QueryIdToken(s_authInterface, &options, (void *)*p_options, [](const EOS_Auth_QueryIdTokenCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("auth_interface_query_id_token_callback", ref_ret);
    });

    return SIGNAL("auth_interface_query_id_token_callback");
}

Signal IEOS::auth_interface_verify_id_token(Ref<RefCounted> p_options) {
    ...
    EOS_Auth_VerifyIdToken(s_authInterface, &options, (void *)*p_options, [](const EOS_Auth_VerifyIdTokenCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("auth_interface_verify_id_token_callback", ref_ret);
    });

    return SIGNAL("auth_interface_verify_id_token_callback");
}

Signal IEOS::auth_interface_link_account(Ref<RefCounted> p_options) {
    Ref<EOSGContinuanceToken> p_continuance_token = Object::cast_to<EOSGContinuanceToken>(p_options->get("continuance_token"));
    ERR_FAIL_NULL_V_MSG(p_continuance_token, Signal(singleton, "auth_interface_link_account_callback"), "Error linking account. LinkAccountOptions.continuance_token is null.");
    ERR_FAIL_NULL_V_MSG(p_continuance_token->get_internal(), Signal(singleton, "auth_interface_link_account_callback"), "Error linking account. EOSGContinuanceToken is null.");
    ...
    EOS_Auth_LinkAccount(s_authInterface, &options, (void *)*p_options, [](const EOS_Auth_LinkAccountCallbackInfo *data) {
        ...
        ret["pin_grant_info"] = eosg_auth_pin_grant_info_to_dict(data->PinGrantInfo);
        ret["selected_account_id"] = eosg_epic_account_id_to_string(data->SelectedAccountId);
        IEOS::get_singleton()->emit_signal("auth_interface_link_account_callback", ref_ret);
    });

    return SIGNAL("auth_interface_link_account_callback");
}

Signal IEOS::auth_interface_verify_user_auth(Ref<RefCounted> p_options) {
    ...
    EOS_Auth_VerifyUserAuth(s_authInterface, &options, (void *)*p_options, [](const EOS_Auth_VerifyUserAuthCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["client_data"] = client_data->get("client_data");
        IEOS::get_singleton()->emit_signal("auth_interface_verify_user_auth_callback", ref_ret);
    });

    return SIGNAL("auth_interface_verify_user_auth_callback");
}
