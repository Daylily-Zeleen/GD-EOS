...
class IEOS : public Object {
    ...
    bool platform_tick_by_scene_tree = true;

#define SIGNAL(sn) Signal(singleton, SNAME(sn))

    // Callback
    static const StringName &get_cb_meta_name() { return SNAME("_CB_"); }
    // Request Wrapper
    static const StringName &get_rw_meta_name() { return SNAME("_RW_"); }

    void platform_tick_internal();
...
public:
    ...
    // Platform Interface
    // -----
    void platform_interface_set_tick_by_scene_tree(bool p_enabled);
    bool platform_interface_is_tick_by_scene_tree();
    ...
    EOS_EResult platform_interface_check_for_launcher_and_restart();
    EOS_EApplicationStatus platform_interface_get_application_status();
    EOS_ENetworkStatus platform_interface_get_network_status();
    EOS_EResult platform_interface_initialize(Ref<RefCounted> options);
    EOS_EResult platform_interface_set_application_status(EOS_EApplicationStatus status);
    EOS_EResult platform_interface_set_network_status(EOS_ENetworkStatus status);
    EOS_EResult platform_interface_set_override_country_code(const String &country_code);
    EOS_EResult platform_interface_set_override_locale_code(const String &locale_code);
    EOS_EResult platform_interface_shutdown();
    void platform_interface_release();

    // -----
    // Logging Interface
    // -----
    EOS_EResult logging_interface_set_log_level(int category, int level);
    ...
    Signal auth_interface_delete_persistent_auth(Ref<RefCounted> options);
    Signal auth_interface_link_account(Ref<RefCounted> options);
    Signal auth_interface_login(Ref<RefCounted> options);
    Signal auth_interface_logout(Ref<RefCounted> options);
    Signal auth_interface_query_id_token(Ref<RefCounted> options);
    Signal auth_interface_verify_id_token(Ref<RefCounted> options);
    Signal auth_interface_verify_user_auth(Ref<RefCounted> _options);
    ...
    EOS_ELoginStatus connect_interface_get_login_status(const String &local_user_id);
    ...
    Signal connect_interface_create_device_id(Ref<RefCounted> options);
    Signal connect_interface_create_user(Ref<RefCounted> options);
    Signal connect_interface_delete_device_id(Ref<RefCounted> options);
    Signal connect_interface_link_account(Ref<RefCounted> options);
    Signal connect_interface_login(Ref<RefCounted> options);
    Signal connect_interface_query_product_user_id_mappings(Ref<RefCounted> options);
    Signal connect_interface_transfer_device_id_account(Ref<RefCounted> options);
    Signal connect_interface_unlink_account(Ref<RefCounted> options);
    Signal connect_interface_verify_id_token(Ref<RefCounted> options);
    ...
    Signal achievements_interface_query_definitions(Ref<RefCounted> options);
    Signal achievements_interface_query_player_achievements(Ref<RefCounted> options);
    Signal achievements_interface_unlock_achievements(Ref<RefCounted> options);

    // -----
    // Custom Invites Interface
    // -----
    EOS_EResult custom_invites_interface_finalize_invite(Ref<RefCounted> options);
    EOS_EResult custom_invites_interface_set_custom_invite(Ref<RefCounted> options);
    Signal custom_invites_interface_accept_request_to_join(Ref<RefCounted> options);
    Signal custom_invites_interface_reject_request_to_join(Ref<RefCounted> options);
    Signal custom_invites_interface_send_custom_invite(Ref<RefCounted> options);
    Signal custom_invites_interface_send_request_to_join(Ref<RefCounted> options);
    ...
    Signal stats_interface_ingest_stat(Ref<RefCounted> options);
    Signal stats_interface_query_stats(Ref<RefCounted> options);
    ...
    Signal leaderboards_interface_query_leaderboard_definitions(Ref<RefCounted> options);
    Signal leaderboards_interface_query_leaderboard_ranks(Ref<RefCounted> options);
    Signal leaderboards_interface_query_leaderboard_user_scores(Ref<RefCounted> options);
    ...
    EOS_EFriendsStatus friends_interface_get_status(Ref<RefCounted> options);
    ...
    Signal friends_interface_accept_invite(Ref<RefCounted> options);
    Signal friends_interface_query_friends(Ref<RefCounted> options);
    Signal friends_interface_reject_invite(Ref<RefCounted> options);
    Signal friends_interface_send_invite(Ref<RefCounted> options);
    ...
    EOS_OnlinePlatformType user_info_interface_get_local_platform_type(Ref<RefCounted> options);
    Signal user_info_interface_query_user_info_by_display_name(Ref<RefCounted> options);
    Signal user_info_interface_query_user_info_by_external_account(Ref<RefCounted> options);
    Signal user_info_interface_query_user_info(Ref<RefCounted> options);
    ...
    Signal ecom_interface_checkout(Ref<RefCounted> options);
    Signal ecom_interface_query_entitlements(Ref<RefCounted> options);
    Signal ecom_interface_query_offers(Ref<RefCounted> options);
    Signal ecom_interface_query_ownership_token(Ref<RefCounted> options);
    Signal ecom_interface_query_ownership(Ref<RefCounted> options);
    Signal ecom_interface_redeem_entitlements(Ref<RefCounted> options);
    Signal ecom_interface_query_entitlement_token(Ref<RefCounted> options);
    Signal ecom_interface_query_ownership_by_sandbox_ids(Ref<RefCounted> options);
    ...
    bool ui_interface_is_valid_button_combination(EOS_UI_EInputStateButtonFlags button_combination);
    bool ui_interface_is_valid_key_combination(EOS_UI_EKeyCombination key_combination);
    EOS_EResult ui_interface_acknowledge_event_id(Ref<RefCounted> options);
    EOS_UI_ENotificationLocation ui_interface_get_notification_location_preference();
    EOS_EResult ui_interface_get_toggle_friends_button(Ref<RefCounted> options);
    EOS_UI_EKeyCombination ui_interface_get_toggle_friends_key(Ref<RefCounted> options);
    EOS_EResult ui_interface_pause_social_overlay(Ref<RefCounted> options);
    EOS_EResult ui_interface_pre_present(Ref<RefCounted> options);
    EOS_EResult ui_interface_report_input_state(Ref<RefCounted> options);
    EOS_EResult ui_interface_set_display_preference(Ref<RefCounted> options);
    EOS_EResult ui_interface_set_toggle_friends_button(Ref<RefCounted> options);
    EOS_EResult ui_interface_set_toggle_friends_key(Ref<RefCounted> options);
    Signal ui_interface_hide_friends(Ref<RefCounted> options);
    Signal ui_interface_show_block_player(Ref<RefCounted> options);
    Signal ui_interface_show_friends(Ref<RefCounted> options);
    Signal ui_interface_show_native_profile(Ref<RefCounted> options);
    Signal ui_interface_show_report_player(Ref<RefCounted> options);
    ...
    Signal kws_interface_create_user(Ref<RefCounted> options);
    Signal kws_interface_query_age_gate(Ref<RefCounted> options);
    Signal kws_interface_query_permissions(Ref<RefCounted> options);
    Signal kws_interface_request_permissions(Ref<RefCounted> options);
    Signal kws_interface_update_parent_email(Ref<RefCounted> options);

    // -----
    // Metrics Interface
    // -----
    EOS_EResult metrics_interface_begin_player_session(Ref<RefCounted> options);
    EOS_EResult metrics_interface_end_player_session(Ref<RefCounted> options);

    // -----
    // Mods Interface
    // -----
    Dictionary mods_interface_copy_mod_info(Ref<RefCounted> options);
    Signal mods_interface_enumerate_mods(Ref<RefCounted> options);
    Signal mods_interface_install_mod(Ref<RefCounted> options);
    Signal mods_interface_uninstall_mod(Ref<RefCounted> options);
    Signal mods_interface_update_mod(Ref<RefCounted> options);

    // -----
    // Reports Interface
    // -----
    Signal reports_interface_send_player_behavior_report(Ref<RefCounted> options);

    // -----
    // Progression Snapshot Interface
    // -----
    Dictionary progression_snapshot_interface_begin_snapshot(Ref<RefCounted> options);
    EOS_EResult progression_snapshot_interface_add_progression(Ref<RefCounted> options);
    EOS_EResult progression_snapshot_interface_end_snapshot(Ref<RefCounted> options);
    Signal progression_snapshot_interface_delete_snapshot(Ref<RefCounted> options);
    Signal progression_snapshot_interface_submit_snapshot(Ref<RefCounted> options);
    ...
    Signal presence_interface_query_presence(Ref<RefCounted> options);
    Signal presence_interface_set_presence(Ref<RefCounted> options);
    ...
    Signal lobby_interface_create_lobby(Ref<RefCounted> options);
    Signal lobby_interface_destroy_lobby(Ref<RefCounted> options);
    Signal lobby_interface_hard_mute_member(Ref<RefCounted> options);
    Signal lobby_interface_join_lobby_by_id(Ref<RefCounted> options);
    Signal lobby_interface_join_lobby(Ref<RefCounted> options);
    Signal lobby_interface_kick_member(Ref<RefCounted> options);
    Signal lobby_interface_leave_lobby(Ref<RefCounted> options);
    Signal lobby_interface_promote_member(Ref<RefCounted> options);
    Signal lobby_interface_query_invites(Ref<RefCounted> options);
    Signal lobby_interface_reject_invite(Ref<RefCounted> options);
    Signal lobby_interface_send_invite(Ref<RefCounted> options);
    Signal lobby_interface_update_lobby(Ref<RefCounted> options);
    ...
    EOS_ENATType p2p_interface_get_nat_type();
    EOS_ERelayControl p2p_interface_get_relay_control();
    Signal p2p_interface_query_nat_type();
    void p2p_interface_set_packet_queue_size(Ref<RefCounted> options);
    void p2p_interface_set_port_range(Ref<RefCounted> options);
    void p2p_interface_set_relay_control(EOS_ERelayControl control);
    ...
    EOS_EResult playerdatastorage_interface_delete_cache(Ref<RefCounted> options, const Callable &p_completion_callback);
    Ref<EOSGPlayerDataStorageFileTransferRequest> playerdatastorage_interface_read_file(Ref<RefCounted> options);
    Ref<EOSGPlayerDataStorageFileTransferRequest> playerdatastorage_interface_write_file(Ref<RefCounted> options);
    Signal playerdatastorage_interface_delete_file(Ref<RefCounted> options);
    Signal playerdatastorage_interface_duplicate_file(Ref<RefCounted> options);
    Signal playerdatastorage_interface_query_file_list(Ref<RefCounted> options);
    Signal playerdatastorage_interface_query_file(Ref<RefCounted> options);
    ...
    EOS_EResult titlestorage_interface_delete_cache(Ref<RefCounted> options, const Callable &p_completion_callback);
    int titlestorage_interface_get_file_metadata_count(Ref<RefCounted> options);
    Ref<EOSGTitleStorageFileTransferRequest> titlestorage_interface_read_file(Ref<RefCounted> options);
    Signal titlestorage_interface_query_file_list(Ref<RefCounted> options);
    Signal titlestorage_interface_query_file(Ref<RefCounted> options);
    ...
    Signal sanctions_interface_query_active_player_sanctions(Ref<RefCounted> options);
    ...
    EOS_EResult sessions_interface_dump_session_state(Ref<RefCounted> options);
    int sessions_interface_get_invite_count(Ref<RefCounted> options);
    EOS_EResult sessions_interface_is_user_in_session(Ref<RefCounted> options);
    Signal sessions_interface_destroy_session(Ref<RefCounted> options);
    Signal sessions_interface_end_session(Ref<RefCounted> options);
    Signal sessions_interface_join_session(Ref<RefCounted> options);
    Signal sessions_interface_query_invites(Ref<RefCounted> options);
    Signal sessions_interface_register_players(Ref<RefCounted> options);
    Signal sessions_interface_reject_invite(Ref<RefCounted> options);
    Signal sessions_interface_send_invite(Ref<RefCounted> options);
    Signal sessions_interface_start_session(Ref<RefCounted> options);
    Signal sessions_interface_unregister_players(Ref<RefCounted> options);
    Signal sessions_interface_update_session(Ref<RefCounted> options);
    ...
    EOS_NotificationId rtc_audio_interface_add_notify_audio_before_render(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_NotificationId rtc_audio_interface_add_notify_audio_before_send(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_NotificationId rtc_audio_interface_add_notify_audio_input_state(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_NotificationId rtc_audio_interface_add_notify_audio_output_state(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_NotificationId rtc_audio_interface_add_notify_participant_updated(Ref<RefCounted> options, const Callable &p_completion_callback);
    ...
    EOS_EResult rtc_audio_interface_send_audio(Ref<RefCounted> options);
    Signal rtc_audio_interface_query_input_devices_information(Ref<RefCounted> options);
    Signal rtc_audio_interface_query_output_devices_information(Ref<RefCounted> options);
    Signal rtc_audio_interface_register_platform_user(Ref<RefCounted> options);
    void rtc_audio_interface_remove_notify_audio_before_render(EOS_NotificationId notification_id);
    void rtc_audio_interface_remove_notify_audio_before_send(EOS_NotificationId notification_id);
    void rtc_audio_interface_remove_notify_audio_input_state(EOS_NotificationId notification_id);
    void rtc_audio_interface_remove_notify_audio_output_state(EOS_NotificationId notification_id);
    void rtc_audio_interface_remove_notify_participant_updated(EOS_NotificationId notification_id);
    Signal rtc_audio_interface_set_input_device_settings(Ref<RefCounted> options);
    Signal rtc_audio_interface_set_output_device_settings(Ref<RefCounted> options);
    Signal rtc_audio_interface_unregister_platform_user(Ref<RefCounted> options);
    Signal rtc_audio_interface_update_participant_volume(Ref<RefCounted> options);
    Signal rtc_audio_interface_update_receiving(Ref<RefCounted> options);
    Signal rtc_audio_interface_update_receiving_volume(Ref<RefCounted> options);
    Signal rtc_audio_interface_update_sending(Ref<RefCounted> options);
    Signal rtc_audio_interface_update_sending_volume(Ref<RefCounted> options);

    // -----
    // RTC Interface
    // -----
    EOS_NotificationId rtc_interface_add_notify_disconnected(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_NotificationId rtc_interface_add_notify_participant_status_changed(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_NotificationId rtc_interface_add_notify_room_statistics_updated(Ref<RefCounted> options, const Callable &p_completion_callback);
    EOS_EResult rtc_interface_set_room_setting(Ref<RefCounted> options);
    EOS_EResult rtc_interface_set_setting(Ref<RefCounted> options);
    Signal rtc_interface_block_participant(Ref<RefCounted> options);
    Signal rtc_interface_join_room(Ref<RefCounted> options);
    Signal rtc_interface_leave_room(Ref<RefCounted> options);
    void rtc_interface_remove_notify_disconnected(EOS_NotificationId notification_id);
    void rtc_interface_remove_notify_participant_status_changed(EOS_NotificationId notification_id);
    void rtc_interface_remove_notify_room_statistics_updated(EOS_NotificationId notification_id);
};

} // namespace godot

#include "gen/eos_interfaces.gen.inl"
