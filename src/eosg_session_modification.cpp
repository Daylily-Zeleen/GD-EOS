...
EOS_EResult EOSGSessionModification::add_attribute(const String &p_key, Variant p_value, int p_visibility) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_AddAttribute(m_internal, &options));
}

EOS_EResult EOSGSessionModification::remove_attribute(const String &p_key) {
    CharString key = p_key.utf8();
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_RemoveAttribute(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_allowed_platform_ids(const TypedArray<int> &p_platform_ids) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetAllowedPlatformIds(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_bucket_id(const String &p_bucket_id) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetBucketId(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_host_address(const String &p_host_address) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetHostAddress(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_invites_allowed(bool p_invites_allowed) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetInvitesAllowed(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_max_players(int p_max_players) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetMaxPlayers(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_join_in_progress_allowed(bool p_join_in_progress_allowed) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetJoinInProgressAllowed(m_internal, &options));
}

EOS_EResult EOSGSessionModification::set_permission_level(int p_permission_level) {
    ...
    return static_cast<EOS_EResult>(EOS_SessionModification_SetPermissionLevel(m_internal, &options));
}
