...
EOS_EResult EOSGPresenceModification::set_status(int new_status) {
    ...
    return static_cast<EOS_EResult>(EOS_PresenceModification_SetStatus(m_internal, &options));
}

EOS_EResult EOSGPresenceModification::set_raw_rich_text(const String &p_raw_rich_text) {
    ...
    return static_cast<EOS_EResult>(EOS_PresenceModification_SetRawRichText(m_internal, &options));
}

EOS_EResult EOSGPresenceModification::set_data(Dictionary p_data) {
    ...
    return static_cast<EOS_EResult>(EOS_PresenceModification_SetData(m_internal, &options));
}

EOS_EResult EOSGPresenceModification::delete_data(Array p_keys) {
    ...
    return static_cast<EOS_EResult>(EOS_PresenceModification_DeleteData(m_internal, &options));
}

EOS_EResult EOSGPresenceModification::set_join_info(const String &p_join_info) {
    ...
    return static_cast<EOS_EResult>(EOS_PresenceModification_SetJoinInfo(m_internal, &options));
}