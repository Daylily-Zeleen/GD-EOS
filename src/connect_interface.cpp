...
Signal IEOS::connect_interface_login(Ref<RefCounted> p_options) {
    ...
    EOS_Connect_Login(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_LoginCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("connect_interface_login_callback", ref_ret);
    });

    return SIGNAL("connect_interface_login_callback");
}
...
Signal IEOS::connect_interface_create_device_id(Ref<RefCounted> p_options) {
    ...
    EOS_Connect_CreateDeviceId(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_CreateDeviceIdCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["client_data"] = client_data->get("client_data");
        IEOS::get_singleton()->emit_signal("connect_interface_create_device_id_callback", ref_ret);
    });

    return SIGNAL("connect_interface_create_device_id_callback");
}

Signal IEOS::connect_interface_delete_device_id(Ref<RefCounted> p_options) {
    ...
    EOS_Connect_DeleteDeviceId(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_DeleteDeviceIdCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["client_data"] = client_data->get("client_data");
        IEOS::get_singleton()->emit_signal("connect_interface_delete_device_id_callback", ref_ret);
    });

    return SIGNAL("connect_interface_delete_device_id_callback");
}

Signal IEOS::connect_interface_create_user(Ref<RefCounted> p_options) {
    Ref<EOSGContinuanceToken> p_continuance_token = Object::cast_to<EOSGContinuanceToken>(p_options->get("continuance_token"));
    ERR_FAIL_NULL_V_MSG(p_continuance_token, Signal(singleton, "connect_interface_create_user_callback"), "Error linking account. LinkAccountOptions.continuance_token is null.");
    ERR_FAIL_NULL_V_MSG(p_continuance_token->get_internal(), Signal(singleton, "connect_interface_create_user_callback"), "Error linking account. EOSGContinuanceToken is null.");
    ...
    EOS_Connect_CreateUser(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_CreateUserCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("connect_interface_create_user_callback", ref_ret);
    });

    return SIGNAL("connect_interface_create_user_callback");
}
...
EOS_ELoginStatus IEOS::connect_interface_get_login_status(const String &p_local_user_id) {
    ...
    return static_cast<EOS_ELoginStatus>(EOS_Connect_GetLoginStatus(s_connectInterface, localUserId));
}
...
Signal IEOS::connect_interface_query_product_user_id_mappings(Ref<RefCounted> p_options) {
    ...
    EOS_Connect_QueryProductUserIdMappings(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_QueryProductUserIdMappingsCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("connect_interface_query_product_user_id_mappings_callback", ref_ret);
    });

    return SIGNAL("connect_interface_query_product_user_id_mappings_callback");
}

Signal IEOS::connect_interface_link_account(Ref<RefCounted> p_options) {
    Ref<EOSGContinuanceToken> p_continuance_token = Object::cast_to<EOSGContinuanceToken>(p_options->get("continuance_token"));
    ERR_FAIL_NULL_V_MSG(p_continuance_token, Signal(singleton, "connect_interface_create_user_callback"), "Error linking account. LinkAccountOptions.continuance_token is null.");
    ERR_FAIL_NULL_V_MSG(p_continuance_token->get_internal(), Signal(singleton, "connect_interface_create_user_callback"), "Error linking account. EOSGContinuanceToken is null.");
    ...
    EOS_Connect_LinkAccount(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_LinkAccountCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("connect_interface_link_account_callback", ref_ret);
    });

    return SIGNAL("connect_interface_create_user_callback");
}

Signal IEOS::connect_interface_verify_id_token(Ref<RefCounted> p_options) {
    ...
    EOS_Connect_VerifyIdToken(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_VerifyIdTokenCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("connect_interface_verify_id_token_callback", ref_ret);
    });

    return SIGNAL("connect_interface_verify_id_token_callback");
}

Signal IEOS::connect_interface_transfer_device_id_account(Ref<RefCounted> p_options) {
    ...
    EOS_Connect_TransferDeviceIdAccount(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_TransferDeviceIdAccountCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("connect_interface_transfer_device_id_account_callback", ref_ret);
    });

    return SIGNAL("connect_interface_transfer_device_id_account_callback");
}

Signal IEOS::connect_interface_unlink_account(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Connect_UnlinkAccount(s_connectInterface, &options, (void *)*p_options, [](const EOS_Connect_UnlinkAccountCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("connect_interface_unlink_account_callback", ref_ret);
    });

    return SIGNAL("connect_interface_unlink_account_callback");
}
