...
Signal IEOS::achievements_interface_query_definitions(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Achievements_QueryDefinitions(s_achievementsInterface, &options, (void *)*p_options, [](const EOS_Achievements_OnQueryDefinitionsCompleteCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal(SNAME("achievements_interface_query_definitions_callback"), ref_ret);
    });

    return SIGNAL("achievements_interface_query_definitions_callback");
}
...
Signal IEOS::achievements_interface_query_player_achievements(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString target_user_id = VARIANT_TO_CHARSTRING(p_options->get("target_user_id"));
    ...
    EOS_Achievements_QueryPlayerAchievements(s_achievementsInterface, &options, (void *)*p_options, [](const EOS_Achievements_OnQueryPlayerAchievementsCompleteCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal(SNAME("achievements_interface_query_player_achievements_callback"), ref_ret);
    });

    return SIGNAL("achievements_interface_query_player_achievements_callback");
}

Signal IEOS::achievements_interface_unlock_achievements(Ref<RefCounted> p_options) {
    CharString user_id = VARIANT_TO_CHARSTRING(p_options->get("user_id"));
    ...
    EOS_Achievements_UnlockAchievements(s_achievementsInterface, &options, (void *)*p_options, [](const EOS_Achievements_OnUnlockAchievementsCompleteCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal(SNAME("achievements_interface_unlock_achievements_callback"), ref_ret);
    });
