...
EOS_EResult IEOS::rtc_audio_interface_send_audio(Ref<RefCounted> p_options) {
    // TODO: implement sending audio
    return static_cast<EOS_EResult>(EOS_EResult::EOS_NotImplemented);
}

Signal IEOS::rtc_audio_interface_query_input_devices_information(Ref<RefCounted> p_options) {
    ...
    EOS_RTCAudio_QueryInputDevicesInformation(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_OnQueryInputDevicesInformationCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_query_input_devices_information_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_query_input_devices_information_callback");
}

Signal IEOS::rtc_audio_interface_query_output_devices_information(Ref<RefCounted> p_options) {
    ...
    EOS_RTCAudio_QueryOutputDevicesInformation(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_OnQueryOutputDevicesInformationCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        client_data->unreference();
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_query_output_devices_information_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_query_output_devices_information_callback");
}

Signal IEOS::rtc_audio_interface_register_platform_user(Ref<RefCounted> p_options) {
    ...
    EOS_RTCAudio_RegisterPlatformUser(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_OnRegisterPlatformUserCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_register_platform_user_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_register_platform_user_callback");
}

Signal IEOS::rtc_audio_interface_set_input_device_settings(Ref<RefCounted> p_options) {
    ...
    EOS_RTCAudio_SetInputDeviceSettings(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_OnSetInputDeviceSettingsCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_set_input_device_settings_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_set_input_device_settings_callback");
}

Signal IEOS::rtc_audio_interface_set_output_device_settings(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString real_device_id = VARIANT_TO_CHARSTRING(p_options->get("real_device_id"));
    ...
    EOS_RTCAudio_SetOutputDeviceSettings(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_OnSetOutputDeviceSettingsCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["real_device_id"] = EOSG_GET_STRING(data->RealDeviceId);
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_set_output_device_settings_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_set_output_device_settings_callback");
}

Signal IEOS::rtc_audio_interface_unregister_platform_user(Ref<RefCounted> p_options) {
    CharString platform_user_id = VARIANT_TO_CHARSTRING(p_options->get("platform_user_id"));
    ...
    EOS_RTCAudio_UnregisterPlatformUser(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_OnUnregisterPlatformUserCallbackInfo *data) {
        ...
        client_data->unreference();
        ret["platform_user_id"] = EOSG_GET_STRING(data->PlatformUserId);
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_unregister_platform_user_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_unregister_platform_user_callback");
}

Signal IEOS::rtc_audio_interface_update_participant_volume(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_RTCAudio_UpdateParticipantVolume(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_UpdateParticipantVolumeCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_update_participant_volume_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_update_participant_volume_callback");
}

Signal IEOS::rtc_audio_interface_update_receiving_volume(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    float volume = p_options->get("volume");
    ...
    EOS_RTCAudio_UpdateReceivingVolume(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_UpdateReceivingVolumeCallbackInfo *data) {
        ...
        ret["room_name"] = EOSG_GET_STRING(data->RoomName);
        ret["volume"] = data->Volume;
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_update_receiving_volume_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_update_receiving_volume_callback");
}

Signal IEOS::rtc_audio_interface_update_receiving(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    CharString participant_id = VARIANT_TO_CHARSTRING(p_options->get("participant_id"));
    ...
    EOS_RTCAudio_UpdateReceiving(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_UpdateReceivingCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_update_receiving_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_update_receiving_callback");
}

Signal IEOS::rtc_audio_interface_update_sending_volume(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    float volume = p_options->get("volume");
    ...
    EOS_RTCAudio_UpdateSendingVolume(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_UpdateSendingVolumeCallbackInfo *data) {
        ...
        ret["room_name"] = EOSG_GET_STRING(data->RoomName);
        ret["volume"] = data->Volume;
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_update_sending_volume_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_update_sending_volume_callback");
}

Signal IEOS::rtc_audio_interface_update_sending(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    EOS_RTCAudio_UpdateSending(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_UpdateSendingCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_update_sending_callback", ref_ret);
    });

    return SIGNAL("rtc_audio_interface_update_sending_callback");
}

EOS_NotificationId IEOS::rtc_audio_interface_add_notify_audio_before_render(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    p_options->set_meta(get_cb_meta_name(), p_completion_callback);
    p_options->reference();
    ...
    EOS_NotificationId notification_id = EOS_RTCAudio_AddNotifyAudioBeforeRender(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_AudioBeforeRenderCallbackInfo *data) {
        ...
        Callable cb = client_data->get_meta(get_cb_meta_name());
        if (cb.is_valid()) {
            cb.call(ref_ret);
        }

        IEOS::get_singleton()->emit_signal("rtc_audio_interface_audio_before_render_callback", ref_ret);
    });

    return static_cast<EOS_NotificationId>(notification_id);
}

EOS_NotificationId IEOS::rtc_audio_interface_add_notify_audio_before_send(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    EOS_NotificationId notification_id = EOS_RTCAudio_AddNotifyAudioBeforeSend(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_AudioBeforeSendCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_audio_before_send_callback", ref_ret);
    });
    return static_cast<EOS_NotificationId>(notification_id);
}

EOS_NotificationId IEOS::rtc_audio_interface_add_notify_audio_input_state(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    EOS_NotificationId notification_id = EOS_RTCAudio_AddNotifyAudioInputState(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_AudioInputStateCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_audio_input_state_callback", ref_ret);
    });
    return static_cast<EOS_NotificationId>(notification_id);
}

EOS_NotificationId IEOS::rtc_audio_interface_add_notify_audio_output_state(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    EOS_NotificationId notification_id = EOS_RTCAudio_AddNotifyAudioOutputState(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_AudioOutputStateCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_audio_output_state_callback", ref_ret);
    });
    return static_cast<EOS_NotificationId>(notification_id);
}

EOS_NotificationId IEOS::rtc_audio_interface_add_notify_participant_updated(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    EOS_NotificationId notification_id = EOS_RTCAudio_AddNotifyParticipantUpdated(s_rtcAudioInterface, &options, (void *)*p_options, [](const EOS_RTCAudio_ParticipantUpdatedCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_audio_interface_participant_updated_callback", ref_ret);
    });

    return static_cast<EOS_NotificationId>(notification_id);
}

void IEOS::rtc_audio_interface_remove_notify_audio_before_render(EOS_NotificationId p_notification_id) {
    EOS_RTCAudio_RemoveNotifyAudioBeforeRender(s_rtcAudioInterface, static_cast<EOS_NotificationId>(p_notification_id));
}

void IEOS::rtc_audio_interface_remove_notify_audio_before_send(EOS_NotificationId p_notification_id) {
    EOS_RTCAudio_RemoveNotifyAudioBeforeSend(s_rtcAudioInterface, static_cast<EOS_NotificationId>(p_notification_id));
}

void IEOS::rtc_audio_interface_remove_notify_audio_input_state(EOS_NotificationId p_notification_id) {
    EOS_RTCAudio_RemoveNotifyAudioInputState(s_rtcAudioInterface, static_cast<EOS_NotificationId>(p_notification_id));
}

void IEOS::rtc_audio_interface_remove_notify_audio_output_state(EOS_NotificationId p_notification_id) {
    EOS_RTCAudio_RemoveNotifyAudioOutputState(s_rtcAudioInterface, static_cast<EOS_NotificationId>(p_notification_id));
}

void IEOS::rtc_audio_interface_remove_notify_participant_updated(EOS_NotificationId p_notification_id) {
