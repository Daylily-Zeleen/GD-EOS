...
Signal IEOS::ecom_interface_checkout(Ref<RefCounted> p_options) {
    ...
    EOS_Ecom_Checkout(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_CheckoutCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ecom_interface_checkout_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_checkout_callback");
}
...
Signal IEOS::ecom_interface_query_entitlements(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Ecom_QueryEntitlements(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_QueryEntitlementsCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_epic_account_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("ecom_interface_query_entitlements_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_query_entitlements_callback");
}

Signal IEOS::ecom_interface_query_offers(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString override_catalog_namespace = VARIANT_TO_CHARSTRING(p_options->get("override_catalog_namespace"));
    ...
    EOS_Ecom_QueryOffers(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_QueryOffersCallbackInfo *data) {
        ...
        ret["client_data"] = client_data->get("client_data");
        ret["local_user_id"] = eosg_epic_account_id_to_string(data->LocalUserId);
        IEOS::get_singleton()->emit_signal("ecom_interface_query_offers_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_query_offers_callback");
}

Signal IEOS::ecom_interface_query_ownership(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Ecom_QueryOwnership(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_QueryOwnershipCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ecom_interface_query_ownership_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_query_ownership_callback");
}

Signal IEOS::ecom_interface_query_ownership_token(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString catalog_namespace = VARIANT_TO_CHARSTRING(p_options->get("catalog_namespace"));
    ...
    EOS_Ecom_QueryOwnershipToken(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_QueryOwnershipTokenCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ecom_interface_query_ownership_token_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_query_ownership_token_callback");
}

Signal IEOS::ecom_interface_redeem_entitlements(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Ecom_RedeemEntitlements(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_RedeemEntitlementsCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ecom_interface_redeem_entitlements_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_redeem_entitlements_callback");
}
...
Signal IEOS::ecom_interface_query_entitlement_token(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Ecom_QueryEntitlementToken(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_QueryEntitlementTokenCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ecom_interface_query_entitlement_token_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_query_entitlement_token_callback");
}

Signal IEOS::ecom_interface_query_ownership_by_sandbox_ids(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    ...
    EOS_Ecom_QueryOwnershipBySandboxIds(s_ecomInterface, &options, (void *)*p_options, [](const EOS_Ecom_QueryOwnershipBySandboxIdsCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("ecom_interface_query_ownership_by_sandbox_ids_callback", ref_ret);
    });

    return SIGNAL("ecom_interface_query_ownership_by_sandbox_ids_callback");
}