...
Signal IEOS::rtc_interface_join_room(Ref<RefCounted> p_options) {
    ...
    EOS_RTC_JoinRoom(s_rtcInterface, &options, (void *)*p_options, [](const EOS_RTC_JoinRoomCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_interface_join_room_callback", ref_ret);
    });

    return SIGNAL("rtc_interface_join_room_callback");
}

Signal IEOS::rtc_interface_leave_room(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    EOS_RTC_LeaveRoom(s_rtcInterface, &options, (void *)*p_options, [](const EOS_RTC_LeaveRoomCallbackInfo *data) {
        ...
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        ret["room_name"] = EOSG_GET_STRING(data->RoomName);
        IEOS::get_singleton()->emit_signal("rtc_interface_leave_room_callback", ref_ret);
    });

    return SIGNAL("rtc_interface_leave_room_callback");
}

Signal IEOS::rtc_interface_block_participant(Ref<RefCounted> p_options) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    CharString participant_id = VARIANT_TO_CHARSTRING(p_options->get("participant_id"));
    ...
    EOS_RTC_BlockParticipant(s_rtcInterface, &options, (void *)*p_options, [](const EOS_RTC_BlockParticipantCallbackInfo *data) {
        ...
        IEOS::get_singleton()->emit_signal("rtc_interface_block_participant_callback", ref_ret);
    });

    return SIGNAL("rtc_interface_block_participant_callback");
}

EOS_EResult IEOS::rtc_interface_set_setting(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_RTC_SetSetting(s_rtcInterface, &options));
}

EOS_EResult IEOS::rtc_interface_set_room_setting(Ref<RefCounted> p_options) {
    ...
    return static_cast<EOS_EResult>(EOS_RTC_SetRoomSetting(s_rtcInterface, &options));
}

EOS_NotificationId IEOS::rtc_interface_add_notify_disconnected(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    return static_cast<EOS_NotificationId>(EOS_RTC_AddNotifyDisconnected(s_rtcInterface, &options, (void *)*p_options, [](const EOS_RTC_DisconnectedCallbackInfo *data) {
        INSTANTIATE_DATA_CLASS(data, ret);
        ret["result_code"] = static_cast<EOS_EResult>(data->ResultCode);
        Ref<RefCounted> client_data = reinterpret_cast<RefCounted *>(data->ClientData);
        client_data->unreference();
        ...
        IEOS::get_singleton()->emit_signal("rtc_interface_disconnected_callback", ref_ret);
    }));
}

EOS_NotificationId IEOS::rtc_interface_add_notify_participant_status_changed(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    return static_cast<EOS_NotificationId>(EOS_RTC_AddNotifyParticipantStatusChanged(s_rtcInterface, &options, (void *)*p_options, [](const EOS_RTC_ParticipantStatusChangedCallbackInfo *data) {
        INSTANTIATE_DATA_CLASS(data, ret);
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        ret["room_name"] = EOSG_GET_STRING(data->RoomName);
        ret["participant_id"] = eosg_product_user_id_to_string(data->ParticipantId);
        ...
        IEOS::get_singleton()->emit_signal("rtc_interface_participant_status_changed_callback", ref_ret);
    }));
}

EOS_NotificationId IEOS::rtc_interface_add_notify_room_statistics_updated(Ref<RefCounted> p_options, const Callable &p_completion_callback) {
    CharString local_user_id = VARIANT_TO_CHARSTRING(p_options->get("local_user_id"));
    CharString room_name = VARIANT_TO_CHARSTRING(p_options->get("room_name"));
    ...
    return static_cast<EOS_NotificationId>(EOS_RTC_AddNotifyRoomStatisticsUpdated(s_rtcInterface, &options, (void *)*p_options, [](const EOS_RTC_RoomStatisticsUpdatedInfo *data) {
        INSTANTIATE_DATA_CLASS(data, ret);
        ret["local_user_id"] = eosg_product_user_id_to_string(data->LocalUserId);
        ret["room_name"] = EOSG_GET_STRING(data->RoomName);
        ...
        IEOS::get_singleton()->emit_signal("rtc_interface_room_statistics_updated_callback", ref_ret);
    }));
}

void IEOS::rtc_interface_remove_notify_disconnected(EOS_NotificationId p_notification_id) {
    EOS_RTC_RemoveNotifyDisconnected(s_rtcInterface, static_cast<EOS_NotificationId>(p_notification_id));
}

void IEOS::rtc_interface_remove_notify_participant_status_changed(EOS_NotificationId p_notification_id) {
    EOS_RTC_RemoveNotifyParticipantStatusChanged(s_rtcInterface, static_cast<EOS_NotificationId>(p_notification_id));
}

void IEOS::rtc_interface_remove_notify_room_statistics_updated(EOS_NotificationId p_notification_id) {
